...
calendar::event::event(const date &newDate, const std::string &newName, const std::string &newEvDescription, const repeatCycle &newRepeat){
...
std::string calendar::event::getEvName() const noexcept{
	return this->evName;
}
