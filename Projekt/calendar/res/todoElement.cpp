...
calendar::todoElement::todoElement(const unsigned long int &position,
...
void calendar::todoElement::incrementPosition() { this->position++; }
...
std::string calendar::todoElement::exportData() const noexcept {
    std::string result = std::to_string(this->getPosition()) + ":" +
                         this->getDataRecord() + "\n";
    return result;
}
