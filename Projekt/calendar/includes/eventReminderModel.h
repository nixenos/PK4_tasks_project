...
namespace calendar{
	...
	public:
		...
		/**
		 * @brief konstruktor bezargumentowy, tworzy pusty obiekt o wszystkich polach NULL
		 */
		eventReminder();

		/**
		 * @brief konstruktor wieloargumentowy, tworzy obiekt o wszystkich właściwościach
		 */
		eventReminder(const date &newDate, const std::string &newName, const repeatCycle &newRepeat,
					  const std::string &newEvLocation, const std::string &newEvType);
