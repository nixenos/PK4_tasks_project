...
namespace calendar{
	...
	public:
		...
		/**
		 * @brief konstruktor bezargumentowy, tworzy pusty obiekt, wszystko ustawia na NULL
		 */
		eventBirthday();
		 ...
		 */
		eventBirthday(const date &newDate, const std::string &newName, const repeatCycle &newRepeat,
					  const std::string &newFirstName, const std::string &newLastName, const date &newBirthDate);
